export default function hotjar () {
    (function (h, o, t, j, a, r) { h.hj = h.hj || function () { (h.hj.q = h.hj.q || []).push(arguments); }; h._hjSettings = { hjid: 3080684, hjsv: 6 };
    h.hj('event', 'example-event');
    h.hj('event', 'example-event-2');
    h.hj('event', 360);
